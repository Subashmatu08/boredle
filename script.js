...
// const targetWord = targetWords[Math.floor(Math.random() * 0.1 + dayOffset)];
...
function checkWinLose(guess, tiles) {
  if (guess === targetWord) {
    showAlert("You Guessed the Right Word", 5000);
    jumpTiles(tiles);
    stopInteraction();
    return;
  }
